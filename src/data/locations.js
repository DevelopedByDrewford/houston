...
const locations = [
    ...
    },
    {
        ...
        badges: ['drive thru', 'open late', 'NFC mobile payments'],
    ...
    },
    {
        ...
        badges: ['open late', 'NFC mobile payments', 'vegetarian options', 'alcohol available'],
    ...
    },
    {
        ...
        badges: ['black owned', 'paid parking', 'NFC mobile payments', 'alcohol available'],
    ...
    },    
    {
        ...
        category: 'food',
        subcategory: ['pizza'],
        badges: ['open late', 'vegetarian options', 'alcohol available'],
    ...
    },
    {
        ...
        category: 'food',
        subcategory: ['chicken'],
        badges: ['open late', 'outdoor seating', 'vegetarian options', 'alcohol available'],
    ...
    },
    {
        ...
        category: 'food',
        subcategory: ['chicken'],
        badges: ['paid parking', 'vegetarian options'],
    ...
    },
    {
        ...
        category: 'food',
        subcategory: ['hall'],
        badges: ['NFC mobile payments', 'paid parking', 'outdoor seating', 'alcohol available', 'photogenic'],
    ...
    },
    {
        ...
        category: 'food',
        subcategory: ['burgers'],
        badges: ['drive thru', 'NFC mobile payments'],
    ...
    },
    {
        name: "Lucille's",
        category: 'food',
        subcategory: ['chicken', 'soup', 'salads'],
        badges: ['black owned', 'vegetarian options', 'alcohol available'],
    ...
    },
    {
        name: "Killen's",
        category: 'food',
        subcategory: ['upscale', 'sandwiches', 'chicken', 'steak', 'salads'],
        badges: ['michelin rated', 'vegetarian options', 'alcohol available'],
    ...
    },
    {
        name: "Bibo's Bistro",
        category: 'food',
        subcategory: ['pho', 'sandwiches', 'soup'],
        badges: ['paid parking', 'outdoor seating', 'NFC mobile payments', 'alcohol available'],
    ...
    },
    {
        name: 'Daily Gather',
        category: 'food',
        subcategory: ['breakfast', 'sandwiches', 'burgers'],
        badges: ['paid parking', 'outdoor seating', 'alcohol available', 'salads', 'soup'],
    ...
    },
    {
        name: 'Bungalow',
        category: 'food',
        subcategory: ['upscale', 'steak', 'pasta', 'salads', 'soup'],
    ...
    },
    {
        ...
        category: 'food',
        subcategory: ['upscale', 'steak', 'soup'],
        badges: ['NFC mobile payments', 'vegetarian options', 'alcohol available'],
    ...
    },
    {
        name: 'Lucy Ethiopian',
        category: 'food',
        subcategory: ['ricebowl', 'pasta', 'salads'],
        badges: ['NFC mobile payments', 'vegetarian options', 'alcohol available'],
    ...
    },
    {
        ...
        category: 'food',
        subcategory: ['chicken', 'seafood', 'soup'],
        badges: ['NFC mobile payments'],
    ...
    },
    {
        name: "Doña Leti’s",
        category: 'food',
        subcategory: ['tacos', 'burritos', 'salads'],
        badges: ['NFC mobile payments', 'vegetarian options', 'alcohol available'],
    ...
    },
    {
        ...
        category: 'bar',
        subcategory: ['burgers', 'sandwiches'],
        badges: ['open late', 'paid parking', 'NFC mobile payments', 'outdoor seating', 'alcohol available'],
